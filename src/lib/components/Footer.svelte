  ...
  <div class="max-w-5xl mx-auto px-6 py-12">
    <div class="flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <div class="text-center md:text-left">
        <p class="font-heading font-bold text-text text-sm tracking-wide">Andreas Sjöberg</p>
        <p class="text-text-muted text-xs mt-1">{contact.location} · Sweden</p>
      </div>
    ...
    <div class="mt-8 pt-6 border-t border-bg-border/50">
      <p class="text-center text-text-muted text-xs">
        © {new Date().getFullYear()} Andreas Sjöberg
      </p>
    </div>
  </div>
</footer>
